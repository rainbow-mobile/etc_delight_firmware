...
void InitCAN(){
	...
	//****************************** SETTING CAN IDs ***********************************************//
    Ecan1ConfigureRxAcptFilter(0, 0x120+BNO*2, 0xFF, 0);			//	store the received message to FIFO
    Ecan1ConfigureRxAcptFilter(1, 0x120+BNO*2+1, 0xFF, 0);			//	store the received message to FIFO
