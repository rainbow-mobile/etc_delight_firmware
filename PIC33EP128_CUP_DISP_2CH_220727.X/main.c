...
//        motor_current = temp;
        ...
        switch(ultra_sonic_state_A){
            case 1:
            {
                rising_edge_A = 1;
                falling_edge_rcvd_A = 0;
                SONAR_TRIGGER_UP_A;
                int tt = 0;
                for(tt=0; tt<50; tt++)
                    ;
                SONAR_TRIGGER_DOWN_A;
                ultra_sonic_state_A = 3;
                break;
            }
            case 2:
                SONAR_TRIGGER_DOWN_A;
                ...
                break;
            case 3:
                if(falling_edge_rcvd_A == 1){
                    falling_edge_rcvd_A = 0;

                    glitch_count_A = 0;
                    ultra_sonic_state_A = 4;
                }
                break;
            case 4:
            {
...
//                if(glitch_count > 10){ // 0.5ms
                    if(InputCaptureCount_A == 0){
                        // no glitch
                        int temptemp = 0;
                        if (falling_time_A > rising_time_A) {
                            temptemp = falling_time_A - rising_time_A;
                        }else {
                            temptemp = (PR2 - rising_time_A) + falling_time_A;
                        }
...
//                        CAN_WRITE(0x131, 1, send_data);
                        ...
                        ultra_sonic_avg_A = ultra_sonic_data;
                        if(ultra_sonic_avg_A > 0xFF){
                            ultra_sonic_avg_A = 0xFF;
                        }
                        ultra_sonic_fail_count_A = 0;
                    }else{
                        // there is glitch --> ignore data
                        ;
                    }
                    ultra_sonic_state_A = 0;
//                }
                break;
            }
            default:
        ...
        switch(ultra_sonic_state_B){
            case 1:
            {
                rising_edge_B = 1;
                falling_edge_rcvd_B = 0;
                SONAR_TRIGGER_UP_B;
                int tt = 0;
                for(tt=0; tt<50; tt++)
                    ;
                SONAR_TRIGGER_DOWN_B;
                ultra_sonic_state_B = 3;
                break;
            }
            case 2:
                SONAR_TRIGGER_DOWN_B;
                ...
                break;
            case 3:
                if(falling_edge_rcvd_B == 1){
                    falling_edge_rcvd_B = 0;

                    glitch_count_B = 0;
                    ultra_sonic_state_B = 4;
                }
                break;
            case 4:
            {
//                glitch_count++;
//                if(glitch_count > 10){ // 0.5ms
                    if(InputCaptureCount_B == 0){
                        // no glitch
                        int temptemp = 0;
                        if (falling_time_B > rising_time_B) {
                            temptemp = falling_time_B - rising_time_B;
                        }else {
                            temptemp = (PR2 - rising_time_B) + falling_time_B;
                        }
...
//                        CAN_WRITE(0x131, 1, send_data);
                        ...
                        // (1,000,000 / 625,000) * (1/58) = 0.0275862 ==> 0.0276
                        int ultra_sonic_data = (unsigned short)((float)(temptemp)*0.0276);
                        ultra_sonic_avg_B = ultra_sonic_data;
                        if(ultra_sonic_avg_B > 0xFF){
                            ultra_sonic_avg_B = 0xFF;
                        }
                        ultra_sonic_fail_count_B = 0;
                    }else{
                        // there is glitch --> ignore data
                        ;
                    }
                    ultra_sonic_state_B = 0;
//                }
                break;
            }
            default:
...
void __attribute__((interrupt, no_auto_psv)) _T1Interrupt(void) {
    ...
    if(t1_cnt%100 == 0){   // 10Hz
        ultra_sonic_state_A = 1;
        ultra_sonic_fail_count_A++;
        if(ultra_sonic_fail_count_A > 10){
            ULTRA_SONIC_ERROR_A = 1;
        }else{
            ULTRA_SONIC_ERROR_A = 0;
        }
        
        
        ultra_sonic_state_B = 1;
        ultra_sonic_fail_count_B++;
        if(ultra_sonic_fail_count_B > 10){
            ULTRA_SONIC_ERROR_B = 1;
        }else{
            ULTRA_SONIC_ERROR_B = 0;
        }
    }
