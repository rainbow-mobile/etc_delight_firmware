...
//    TRISEbits.TRISE12 = 1;    // Fault2
    ...
    TRISBbits.TRISB15 = 0;  // M1 PWM2H
    TRISBbits.TRISB12 = 0;  // M2 PWM1H
    TRISBbits.TRISB13 = 0;  // M2 PWM2H
    
    // LED
    TRISBbits.TRISB10 = 0;  // LED R
    TRISAbits.TRISA10 = 0;  // LED G
    TRISCbits.TRISC8 = 0;   // LED B
