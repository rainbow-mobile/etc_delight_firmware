...
//#define LED_TEST_MODE
    
#define YELLOW_R    1500
#define YELLOW_G    1500
#define YELLOW_B    0
...
#define RED_B    0
    ...
    static unsigned int green_blink_cnt = 0;
        ...
        if(timerCnt%3 == 0){
            switch(LED_STATE){
                case 10: // Go Yellow
                    if(PDC3 > YELLOW_R){
                        PDC3 = PDC3 - 1;
                    }else if(PDC3 < YELLOW_R){
                        PDC3 = PDC3 + 1;
                    }
                    if(PDC4 > YELLOW_G){
                        PDC4 = PDC4 - 1;
                    }else if(PDC4 < YELLOW_G){
                        PDC4 = PDC4 + 1;
                    }
                    if(PDC5 > YELLOW_B){
                        PDC5 = PDC5 - 1;
                    }else if(PDC5 < YELLOW_B){
                        PDC5 = PDC5 + 1;
                    }
#ifdef LED_TEST_MODE
                    if(PDC3 == YELLOW_R && PDC4 == YELLOW_G && PDC5 == YELLOW_B){
                        LED_STATE = 20;
                    }
#endif
                    break;
                ...
                case 20: // Go Green
                    if(PDC3 > GREEN_R){
                        PDC3 = PDC3 - 1;
                    }else if(PDC3 < GREEN_R){
                        PDC3 = PDC3 + 1;
                    }
                    if(PDC4 > GREEN_G){
                        PDC4 = PDC4 - 1;
                    }else if(PDC4 < GREEN_G){
                        PDC4 = PDC4 + 1;
                    }
                    if(PDC5 > GREEN_B){
                        PDC5 = PDC5 - 1;
                    }else if(PDC5 < GREEN_B){
                        PDC5 = PDC5 + 1;
                    }
#ifdef LED_TEST_MODE
                    if(PDC3 == GREEN_R && PDC4 == GREEN_G && PDC5 == GREEN_B){
                        green_blink_cnt = 0;
                        LED_STATE = 30;
                    }
#endif
                ...
                case 30:
                    // Green Blinking
                    green_blink_cnt++;
                    if(green_blink_cnt%400 == 0){
                        PDC3 = GREEN_R;
                        PDC4 = GREEN_G;
                        PDC5 = GREEN_B;
                    }else if(green_blink_cnt%400 == 200){
                        PDC3 = 0;
                        PDC4 = 0;
                        PDC5 = 0;
                    }
#ifdef LED_TEST_MODE
                    if(green_blink_cnt == 3100){
                        LED_STATE = 10;
                    }
#endif
                    break;
